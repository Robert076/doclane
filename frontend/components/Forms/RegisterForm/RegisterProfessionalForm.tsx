...
const RegisterProfessionalForm: React.FC<RegisterProfessionalFormProps> = ({
  ...
  return (
    <div className="register-form">
      <Logo />
      <h2 className="register-form-title">Welcome to your Portal</h2>
      <p className="register-form-subtitle">
        Please enter your details to sign up to Doclane.
      </p>
      <Separator />
      <Input
        label="Email:"
      ...
      {showErrors && !isValidEmail(email) && (
        <p className="register-form-error">Please enter a valid email</p>
      )}
      <Input
        label="Password:"
      ...
      {showErrors && firstName.trim().length < 3 && (
        <p className="register-form-error">First name must be at least 3 characters</p>
      )}
      <Input
        label="Last name:"
